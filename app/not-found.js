...
// власної межі not-found у групи (site) бути не може — Next її просто
// ігнорує (перевірено і для [locale]/not-found.js, і для сусіднього
// blog/[slug]/not-found.js, і для experimental global-not-found.js).
// Сюди потрапляють адреси, які не збіглися з жодним маршрутом; невідомі
// слаги статей і циклів приходять теж сюди, бо ті сторінки оголошені
// dynamicParams: false.
//
